...
var VanillaScroll = function () {
  function VanillaScrollspy(menu, head, speed, easing) {
    var head = head || 0;
  ...
  _createClass(VanillaScrollspy, [{
    ...
    value: function menuControl() {
      ...
      var elem = this.head;
      if (elem) {
        var head = document.querySelector(elem);
    ...
    value: function animated() {
      ...
      var menuHeight;
      var elem = this.head;
      if (elem) { //если есть значение селектора
        var head = document.querySelector(elem);
      ...
      function control(e) {
        ...
        self.scrollToY(target.offsetTop - menuHeight);
      }
